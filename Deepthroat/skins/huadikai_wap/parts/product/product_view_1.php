...
<div class="inside_r">
      ...
      <div class="pro_font">
        ...
        <div class="pro_font3">产品简介</div>
			...
			<div class="pro_font5"><a href="<?php echo sys_href(102);?>">申请试用</a></div>
      </div>
      ...
      <div class="pro_tab">
        	<div class="pro_tab_t" id="tab3">
            	<ul>
                	<li onclick="setTab(3,0)" class="now">产品详情</li>
                    <li onclick="setTab(3,1)">热门推荐</li>
                </ul>
          </div>
            <div class="pro_tab_b" id="tablist3">
            	<div class="tablist block"><?php echo $data['content']; ?></div>
  				<div class="tablist">
               	 <div class="in_pro">
                      <ul>
                      	  <?php doc_product($data['channelId'],3,0,0,0,0,true,false,'id',0) ?>
                          <div class="clear"></div>
                      </ul>
                    </div>
                </div>
