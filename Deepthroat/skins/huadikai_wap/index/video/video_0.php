...
<?php }else{?>
<embed src="<?php echo $data['filePath']?>" wmode="transparent" allowFullScreen="true" quality="high" width="314" height="209" align="middle" allowScriptAccess="always" type="application/x-shockwave-flash"></embed>
<?php }?>