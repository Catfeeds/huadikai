...
<div class="cake_r" style="position:relative;">
   ...
   <div id="donghua">
    ...
    <div class="sp8">P</div>
    <div class="sp9">U</div>
    <div class="sp10">D</div>
    <div class="sp11">D</div>
    <div class="sp12">I</div>
    <div class="sp13">N</div>
    <div class="sp14">G</div>
    <div class="cs">端午粽子</div>
    <div class="cg1">新鲜++美味在心</div>
    <div class="cg2">新鲜烘培，精选优质食材，经过13道工序打造美味的面包精品心</div>
    <div class="b1"><img src="<?php echo $tag['path.skin']; ?>images/ricepudding1.jpg" width="271" height="162" /></div>
  <div class="b2"><!--<img src="<?php echo $tag['path.skin']; ?>images/ricepudding2.png" width="108" height="85" />--></div>
  </div>
    <div class="pro">
        <ul id="products_list">
        	<?php
