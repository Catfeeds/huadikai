...
<?php
if(empty($_SESSION[TB_PREFIX.'pay_orderId']))
{
	$_SESSION[TB_PREFIX.'pay_orderId']=$request['orderId'];
	$_SESSION[TB_PREFIX.'pay_subject']=$request['subject'];
	$_SESSION[TB_PREFIX.'pay_body']   =$request['body'];
	$_SESSION[TB_PREFIX.'pay_price']  =$request['price'];
}
$subject = @explode('<@>',$_SESSION[TB_PREFIX.'pay_subject']);
$body    = @explode('<@>',$_SESSION[TB_PREFIX.'pay_body']);
