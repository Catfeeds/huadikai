...
function get_search_result($modelName)
{
	...
	{
		case 'article':
			$sql = "SELECT * FROM ".TB_PREFIX."article WHERE title LIKE '%".$keyword."%' ORDER BY id DESC";
			break;
		case 'list':
			$sql="SELECT * FROM ".TB_PREFIX."list WHERE  title LIKE '%".$keyword."%' ORDER BY id DESC";
			break;
		case 'product':
			$sql="SELECT * FROM ".TB_PREFIX."product  WHERE title LIKE '%".$keyword."%' ORDER BY id DESC";
			break;
		case 'download':
			$sql="SELECT * FROM ".TB_PREFIX."download WHERE title LIKE '%".$keyword."%' ORDER BY id DESC";
			break;
		case 'picture':
		...
		case 'video':
			...
			break;
		case 'jobs':
			$sql="SELECT * FROM ".TB_PREFIX."jobs WHERE  lastTime>='".date('Y-m-d')."' AND (title LIKE '%".$keyword."%')  ORDER BY id DESC";
			break;
		case 'poll':
