          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
			  ...
			  <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td>电话：</td>
                    <td colspan="2"><textarea name="sitemobilephone" id="sitemobilephone" class="txt" cols="27" rows="3"><?php echo htmlspecialchars(stripslashes(SITEMOBILEPHONE)) ?></textarea></td>
                  </tr>
                  <tr>
                    <td>固话：</td>
                    <td colspan="2"><textarea name="sitetelephone" id="sitetelephone" class="txt" cols="27" rows="3"><?php echo htmlspecialchars(stripslashes(SITETELEPHONE)) ?></textarea></td>
                  </tr>
                  <tr>
                    <td>QQ：</td>
                    <td colspan="2"><textarea name="siteqq" id="siteqq" class="txt" cols="27" rows="3"><?php echo htmlspecialchars(stripslashes(SITEQQ)) ?></textarea>
                    </td>
                  </tr>
                  <tr>
                    <td>传真：</td>
                    <td colspan="2"><textarea name="sitefax" id="sitefax" class="txt" cols="27" rows="3"><?php echo htmlspecialchars(stripslashes(SITEFAX)) ?></textarea>
                    </td>
                  </tr>
                  <tr>
                    <td>邮箱：</td>
                    <td colspan="2"><textarea name="siteemail" id="siteemail" class="txt" cols="27" rows="3"><?php echo htmlspecialchars(stripslashes(SITEEMAIL)) ?></textarea></td>
                  </tr>
                  <tr>
                    <td>地址：</td>
                    <td colspan="2"><textarea name="siteaddress" id="siteaddress" class="txt" cols="27" rows="3"><?php echo htmlspecialchars(stripslashes(SITEADDRESS)) ?></textarea>
                    </td>
                  </tr>
                  <tr>
                    <td>站点资源文件上传路径：</td>
